...
public class Funcion_Recurso extends Recurso {
    ...
    public static JSONObject serialize(IFuncion f) {
        ...
        try {
            ...
            jsonResult.put("estado", f.getStatus()); //3. Serializar el estado de una función en el API REST
    ...
    public Representation put(Representation entity) {
        ...
        //5.  Obtenemos el dispositivo y si esta deshabilitado devolvemos un error 403 (no se pueden modificar nada)
        IDispositivo dispositivo = this.getDispositivo_RESTApplication().getDispositivo();
